...
def test_relu_layer(setup_relu_test: dict) -> None:
    tf.keras.backend.set_floatx("float64")
    inputs_3 = setup_relu_test["inputs_3"]
    inputs_2 = setup_relu_test["inputs_2"]
    expected_output_3 = setup_relu_test["expected_output_3"]
    expected_output_2 = setup_relu_test["expected_output_2"]
